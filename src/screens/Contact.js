      ...
      <div class="bg-white dark:bg-dark-primary lg:rounded-lg lg:w-[36rem] lg:h-[560px] py-10 px-10">
        <form action="#" class="space-y-8">
          <div>
            ...
            <input type="email" id="email" class="shadow-sm bg-txt-clr border border-gray-300 text-dark-primary text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" required/>
          </div>
          <div>
            <label for="subject" class="font-lekton font-semibold dark:text-txt-clr block mb-2 text-sm">Email Address</label>
            <input type="text" id="subject" class="block p-3 w-full text-sm text-dark-primary bg-txt-clr rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" required/>
          </div>
          <div class="sm:col-span-2">
            <label for="message" class="font-lekton font-semibold dark:text-txt-clr block mb-2 text-sm">Your message</label>
