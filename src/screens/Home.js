  ...
  return (
    <section className='lg:scrollbar-w-1.5 lg:scrollbar-h-1.5 lg:scrollbar-track-bg-slate-500/50  dark:lg:scrollbar-track-bg-transparent dark:lg:scrollbar-thumb-bg-transparent lg:scrollbar-rounded bg-white dark:bg-dark-primary lg:rounded-lg lg:overflow-y-auto lg:max-w-xl lg:max-h-[560px] py-10 px-10'>
        ...
        <span class='relative before:block before:w-8 before:rounded-full before:absolute before:-inset-0.5 before:bg-blue-400'>
          ...
          <div className="group m-auto relative overflow-hidden border-2 border-black/50 dark:border-white/50 text-gray-700 bg-white rounded-xl w-60 h-60">
            <div className='group-hover bg-black/70 z-40 w-full h-full absolute transition-all duration-300'></div>
              ...
              <div className='absolute -bottom-full left-4 group-hover:bottom-4 transition-all duration-500 z-50'>
                <h5 className="mb-4 text-l text-sky-400 font-bold tracking-tight dark:text-white">MovieHub</h5>
                <p className="mb-4 font-normal text-white dark:text-gray-400">Dynamic movie app crafted with React.js, Tailwind CSS, and API integration.</p>
                <div className="flex items-center mb-4">
                    <div className="flex items-center mr-2">
                      <img src="assets/images/react.png" alt="REACT" className="h-6 mr-4" />
                      <img src="assets/images/tailwindcss.png" alt="TAILWIND CSS" className="h-6 mr-1" />
                    </div>
              </div>
              <div className='flex items-center'>
                <Link to="https://ibrahimtrahim.github.io/movieapp/" target="_blank" className="inline-flex mr-4 items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                  LIVE DEMO
                  <svg className="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                  </svg>
                </Link>
                <Link to="https://github.com/ibrahimtrahim/movieapp" target="_blank">
