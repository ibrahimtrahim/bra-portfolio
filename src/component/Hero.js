  ...
  return (
      <div class="lg:w-full lg:max-w-sm bg-white dark:bg-dark-primary lg:rounded-lg mb-4 lg:mr-2">
          <div class="flex flex-col justify-center items-center py-20 lg:py-40">
            <span class='relative before:block before:rounded-full before:absolute before:-inset-0.5 before:bg-blue-400'>
              ...
              <div className="flex mt-4 md:mt-6 space-x-4">
                <a href="#" className="flex flex-col items-center px-2 mx-2">
                  <svg className='hover:fill-blue-400 dark:fill-white dark:hover:fill-blue-400' xmlns="http://www.w3.org/2000/svg" fill='black' height="20" width="20" viewBox="0 0 448 512">
                ...
                <a href="#" className="flex flex-col items-center px-2 mx-2">
                  <svg className='hover:fill-blue-400 dark:fill-white dark:hover:fill-blue-400' xmlns="http://www.w3.org/2000/svg" fill='black' height="20" width="20" viewBox="0 0 512 512">
                ...
                <a href="#" className="flex flex-col items-center px-2 mx-2">
                  <svg className='hover:fill-blue-400 dark:fill-white dark:hover:fill-blue-400' xmlns="http://www.w3.org/2000/svg" fill='black' height="20" width="20" viewBox="0 0 496 512">
