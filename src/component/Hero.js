          ...
          <div class="flex flex-col justify-center items-center py-20 lg:py-40">
              ...
              <div className="flex mt-4 md:mt-6">
                <a href="#" className="flex flex-col items-center px-2 mx-2 hover:text-blue-400">
                  <svg className='hover:fill-blue-400' xmlns="http://www.w3.org/2000/svg" fill='white' height="20" width="20" viewBox="0 0 448 512">
                ...
                <a href="#" className="flex flex-col items-center px-2 mx-2 hover:text-blue-400">
                  <svg className='hover:fill-blue-400' xmlns="http://www.w3.org/2000/svg" fill='white' height="20" width="20" viewBox="0 0 512 512">
